...
import { removePurchase, savePurchase } from "../store/purchaseSlice";
...
function PurchaseHeader(props) {
    ...
    function handleSavePurchase() {
        dispatch(savePurchase(getValues()));
    }

    function handleRemovePurchase() {
        dispatch(removePurchase()).then(() => {
            navigate("/purchases");
        });
    }
            ...
            <div className="flex flex-col items-center sm:items-start space-y-8 sm:space-y-0 w-full sm:max-w-full min-w-0">
                ...
                >
                    ...
                    >
                        ...
                        <span className="flex mx-4 font-medium">Purchases</span>
                    </Typography>
                </motion.div>
